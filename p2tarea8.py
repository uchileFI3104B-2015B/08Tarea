...
plt.hist(x, bins=100, range=[-10, 10], normed=True,
         color='c', label="Distribucion obtenida")
plt.plot(x_values, W(x_values)/norma, color='r',
         linewidth=2, label="Distribucion deseada")
plt.xlim([-10, 10])
plt.ylim([0, 0.3])
plt.xlabel('$x$')
plt.ylabel('$W(x)$')
