'''
Este script genera los datos a utilizar en el script bonus_con_menos_puntos.py.
Los datos corresponden al valor asociado a cada bin (50 bins desde -10 a 10)
del histograma de la muestra (de 100 puntos) que se obtiene al
